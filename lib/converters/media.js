  ...
  static async convert(job, settings, onProgress) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (isVideoOutput) {
        ...
        // Optimize for Vercel/Serverless: 'medium' is too slow for weak CPUs
        ...
        if (ext === "webm") {
          cmd.videoCodec("libvpx-vp9").outputOptions([
            ...
            String(crf),
            "-preset",
            preset, // Warning: vp9 presets are different, but we'll stick to common names or map them if needed
            "-deadline", // VP9 specific speed optimization
