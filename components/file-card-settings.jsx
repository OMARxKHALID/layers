...
export const SettingButton = ({
  ...
  <button
    onClick={onClick}
    title={title}
    className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-medium border transition-all text-[10px] sm:text-xs ${
      active
...
export const NumericInput = ({
  ...
  <div className="relative flex-grow">
    <input
      ...
      className="w-full bg-white/40 border border-white/20 rounded-xl pl-3 pr-8 py-2 md:py-2.5 text-[10px] sm:text-xs font-medium focus:bg-white focus:border-black/5 outline-none transition-all placeholder:text-gray-400 text-gray-800"
    />
    {unit && (
